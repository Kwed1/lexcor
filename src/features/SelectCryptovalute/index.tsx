		...
		<div className='relative'>
			...
			{isOpen && (
				<motion.div
					...
					className="absolute top-full left-0 right-0 mt-1 bg-crypto-bg-tertiary rounded-xl shadow-crypto-lg border border-crypto-border-primary overflow-hidden z-50"
					data-dropdown="crypto-select"
					onClick={(e) => e.stopPropagation()}
				>
					<ul className='p-2 text-[11px] flex flex-col gap-1 max-h-[180px] overflow-y-auto'>
